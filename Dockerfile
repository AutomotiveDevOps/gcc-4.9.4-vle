...
RUN apt-get install -y --no-install-recommends libmpc-dev
RUN apt-get install -y --no-install-recommends libisl-dev
# Compression library
...
# Parser/lexer generators needed for GCC build
